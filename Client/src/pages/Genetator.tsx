...
const Genetator = () => {
  ...
  const handleGenerate = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!user) return toast("Please login to create a post");
  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          heading="Create Images Post"
          description="Upload your model and product images to compose platform-ready social media posts"
        />
  ...
  transition-all"
            ...
            <div className="mb-4 text-gray-300">
              <label
                ...
                className="block text-sm mb-4 text-gray-300"
              >
                Product Description{" "}
            ...
            <div className="mb-4 text-gray-306">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                placeholder="Add notes for your post caption or styling"
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
              />
            </div>
          </div>
        ...
        <div className="flex justify-center mt-4">
          ...
          >
            {isGenerating ? (
              <>
                <Loader2Icon className="size-5 animate-spin" /> Creating...
              </>
            ) : (
              <>
                <Wand2Icon className="size-5" /> Create Post
              </>
            )}
          </PrimaryButton>
        </div>
